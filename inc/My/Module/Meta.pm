...
sub version_from {
    return 'lib/Date/Tolkien/Shire/Data.pm';
}
...
My::Module::Meta - Information needed to build Date::Tolkien::Shire::Data
...
This module centralizes information needed to build C<Date::Tolkien::Shire::Data>. It
is private to the C<Date::Tolkien::Shire::Data> package, and may be changed or
...
modules required to build the C<Date::Tolkien::Shire::Data> package, suitable for
...
the modules required to run the C<Date::Tolkien::Shire::Data>
...
Copyright (C) 2017-2022 by Thomas R. Wyant, III
